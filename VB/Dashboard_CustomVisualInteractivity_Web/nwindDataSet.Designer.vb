...
Namespace Dashboard_CustomVisualInteractivity_Web
    ...
    End Class
End Namespace
Namespace Dashboard_CustomVisualInteractivity_Web.nwindDataSetTableAdapters
    ...
    Partial Public Class SalesPersonTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Country, ProductName, CategoryName, OrderDate, UnitPrice, Quantity," & " Discount, [Extended Price], [Sales Person]" & ControlChars.CrLf & "FROM            SalesPerson"
